...
contract("MillionrERC1155Test", (accounts) => {
    ...
    it(`mint should emit TransferSingle Event`, async () => {
        ...
        expectEvent(await contract.mint(accounts[0], 0, 1, []), "TransferSingle");
    });
    ...
    it(`mint should revert with zero address `, async () => {
        ...
        await expectRevert(contract.mint(constants.ZERO_ADDRESS, 1, 1, []), "Cannot trash something precious");
    });
    ...
    it(`mint should revert with amount != 1`, async () => {
        ...
        await expectRevert(contract.mint(accounts[0], 1, 1111, []), "Member are unique dawg");
    });
    ...
    it(`mint should revert when totalsupply is reached`, async () => {
        ...
        await expectRevert(contract.mint(accounts[0], 1, 1, []), "The club is full dawg");
    });

    it(`safeTransferFrom should emit TransferSingle`, async () => {
        const contract =  await deployProxy(MillionrERC1155Test, [
            "name",
            "symbol",
            "uri",
        ...
        expectEvent(await contract.safeTransferFrom(accounts[0], accounts[1], 0, 1, []), "TransferSingle");
    });
